class KillCapturingUnit < Achievement
  @queue = :high
  ...
  class << self
    ...
    def description
      'Kill a unit that is attempting to capture a base.'
    end
    ...
    def grant?(command)
      ...
      if info[:defender_capturing] and info[:defender_starting_health] - info[:attacker_damage] <= 0
